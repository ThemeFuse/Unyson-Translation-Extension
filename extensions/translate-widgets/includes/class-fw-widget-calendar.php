 ...
 * @since 2.8.0
 */
class FW_Widget_Calendar extends WP_Widget {
	...
	function get_calendar( $initial = true, $echo = true ) {
		...
		##########################################################
		$fw_query = $wpdb->prepare( " join $wpdb->postmeta as pm1 ON
         $wpdb->posts.ID = pm1.post_id and
         pm1.meta_key='translation_lang' and
         pm1.meta_value=%s", fw_ext( 'translation' )->get_frontend_active_language() );
		##########################################################
