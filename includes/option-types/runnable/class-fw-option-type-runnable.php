...
class FW_Option_Type_Runnable extends FW_Option_Type {
	private $extension_name = 'translation';
	...
	public function _init() {
		add_action( 'wp_ajax_runnable', array( $this, 'run_callback' ) );
	}
	...
	protected function _enqueue_static( $id, $option, $data ) {
		...
		$js_path  = fw()->extensions->get( $this->extension_name )->get_declared_URI( '/includes/option-types/runnable/static/js/runnable.js' );
		$css_path = fw()->extensions->get( $this->extension_name )->get_declared_URI( '/includes/option-types/runnable/static/css/runnable.css' );
